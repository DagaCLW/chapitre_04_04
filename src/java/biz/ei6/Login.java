...
public class Login extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //response.sendRedirect("index.html");                         <- redirection visible du clt pouvant s'appliquer à n'importe quoi
        if (request.getParameter("login").equals("elodie1234")
                && request.getParameter("password").equals("moncomptetwitter")) {       // <- utilisation des paramètres d'invocation par le servlet
